...
echo "Utility function for Unknown Arch"
...
echo "Utility function for detect system"
...
echo "Check if required packages are present"
...
echo "URLs of all possibls architectures"
...
echo "Utility function to get tar file"
...
echo "Utility function to get SHA"
...
echo "Utility function to check integrity"
...
echo "Utility function to extract tar file"
...
echo "Utility function for login file"
...
echo "Utility function to touchup Alpine"
...
echo "Utility function for cleanup"
