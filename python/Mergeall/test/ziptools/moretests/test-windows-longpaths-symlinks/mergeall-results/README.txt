This folder chronicles tests run on Windows.  The tests used mergeall 
to propagate and update data unzipped from the xfer*.zip file here, 
which holds both symlinks and long Windows paths.  Tests were run in 
Admin mode; this is required for creating Windows symlinks, but not 
for long paths. 
