...
COMPILER_CC = 'clang'
CPPPATH_ST = '-I%s'
DEFINES = ['_REENTRANT', '_BSD_SOURCE', '_DEFAULT_SOURCE', 'HAVE_UNSETENV=1', 'HAVE_MKDTEMP=1', 'HAVE_DIRNAME=1', 'HAVE_BASENAME=1', 'HAVE_STRNDUP=1', 'HAVE_STRNLEN=1', 'LAUNCH_DEBUG', 'NDEBUG']
DEFINES_ST = '-D%s'
